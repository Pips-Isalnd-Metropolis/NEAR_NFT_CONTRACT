...
impl NonFungibleTokenCore for Contract {
    ...
    fn nft_transfer_call(
        ...
        */
        ...
        //sender id
        let sender_id = env::predecessor_account_id();
        //tranfer token and get previous token object 
        let previous_token = self.internal_transfer(
            &sender_id,
            &receiver_id,
            &token_id,
        ...
        ext_non_fungible_token_receiver::nft_on_transfer(
            ...
            token_id.clone(),
            msg,
            receiver_id.clone(), //account going to
        ...
        .then(ext_self::nft_resolve_transfer(
            ...
            NO_DEPOSIT, // attached deposit
            GAS_FOR_RESOLVE_TRANSFER, //Gas attached to call
        )).into()
    }
    ...
    fn nft_token(&self, token_id: TokenId) -> Option<JsonToken>{
        if let Some(token) = self.tokens_by_id.get(&token_id) {
            ...
            //if no token ID in the collection retrun None
            None
        }
    }
}
...
impl NonFungibleTokenResolver for Contract {
    ...
    fn nft_resolve_transfer(
        ...
        //get the token object if there are any token object
        ...
        // we change the struct back to roginal owner
        ...
        //log the owner has reveerted back to the orginal 
